...
//displaying products
    function getProducts(){
        global $con;
        $select_query = "Select * from `products` order by rand() LIMIT 0,6";// rand() to show random products on home page and limit -> max no. of products on the home page
        $result_query = mysqli_query($con,$select_query);
    //$row = mysqli_fetch_assoc($result_query);
  //echo $row['product_title']; prints the product title of first product
  while($row = mysqli_fetch_assoc($result_query)){
       ...
       // $product_image2= $row['product_image2'];
        ...
        echo"<div class='col-md-4 mb-3'style='width: 18rem;'>
